  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        accent: {
          DEFAULT: "var(--color-accent)", /* slate-800 */
        ...
        growth: {
          DEFAULT: "var(--color-growth)", /* emerald-600 */
          foreground: "var(--color-growth-foreground)", /* slate-50 */
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      animation: {
        ...
        "pulse-update": "pulse-fade 3s ease-out",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-fade": {
          "0%": { backgroundColor: "rgba(37, 99, 235, 0.2)" },
